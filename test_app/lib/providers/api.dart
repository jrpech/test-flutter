...
import 'package:test_app/providers/payloads/movies_response.dart';
...
class ApiProvider extends ApiBase {
  ...
  static const String _MOVIES = "v2/movies?country_code=MX&cinema=61";
  ...
  Future<List<Movie>> getMovies() async {
    this.apiKey = 'stage_HNYh3RaK_Test';
    final response = await this.get(_MOVIES);
    Map<String, dynamic> json = jsonDecode(response.body.toString());
    print(json);
    MoviesResponse profileResponse = MoviesResponse.fromJson(json);
    return profileResponse.movies;
  }
}
